...
test.describe("US-18 ใส่เงินเพิ่มหรือถอนเงินระหว่างทาง", () => {
  ...
  test("EC-CMP-17 เปิดตัวเลือกแล้วปิดกลับ ได้ค่าเดิมทุกหลัก", async ({ page }) => {
    /**
     * ข้อนี้รอผลคำนวณ **สองรอบ** จึงช้ากว่าข้ออื่นโดยธรรมชาติ
     *
     * งบเวลาของทั้งข้อต้องมากกว่างบของตัวรอข้างล่าง ไม่งั้นตัวรอไม่มีทางได้เวลาที่ขอไว้เลย —
     * เดิมตั้งตัวรอไว้ 30 วินาทีเท่ากับงบเริ่มต้นของทั้งข้อพอดี การเพิ่มเวลาให้ตัวรอจึงไม่เคยมีผล
     * และข้อนี้กลับมาแดงตอนรันทั้งชุดซ้ำอีกเป็นครั้งที่สาม
     */
