...
- **สถานะ:** ✅ เฟส 0, 1, **2 (เทียบพอร์ต + เงินเข้าออก)** และ **3 (ตลาดไทย)** เสร็จแล้ว (ใช้งานจริงที่ folio-lab-gamma.vercel.app)
...
**ยังเหลือที่ S19:** 4.4 ช่วงวิกฤต · 4.5 อัตราถอนปลอดภัย
