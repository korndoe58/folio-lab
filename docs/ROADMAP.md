...
### งานข้ามเฟส — การ์ดพรีวิวตอนแชร์ลิงก์ (S20) ✅

ไม่ได้อยู่ในแผนเดิม · เกิดขึ้นตอนจะเอาลิงก์ไปแชร์จริงแล้วพบว่าหน้าเว็บ**ไม่ได้ส่งข้อมูลพรีวิวออกไปเลย**
แพลตฟอร์มจึงวาดเป็นกล่องเทาที่มีแค่คำว่า `folio-lab` — ของที่ตั้งใจให้คนเห็นกลับดูเหมือนลิงก์เสีย

ตรวจเจอพร้อมกันว่า**ข้อความที่ผู้ใช้เห็นสามจุดยังโฆษณากองทุนรวมไทย** ทั้งที่ [PD-012](./product/decision-log.md)
พักไว้ตั้งแต่ 2026-07-30 เพราะแหล่งข้อมูลไม่มีให้ · สองเรื่องนี้แยกกันไม่ได้เพราะคำอธิบายพรีวิวดึงจาก
ข้อความชุดเดียวกัน — ทำการ์ดโดยไม่แก้คำอ้าง เท่ากับขยายคำอ้างที่ไม่จริงให้กว้างขึ้น

ผลลัพธ์ ([US-36](./product/stories/social-preview/US-36-link-preview-card.md) · [PD-026](./product/decision-log.md)):
ข้อมูลพรีวิวครบตั้งที่ layout ราก จึงตกทอดถึงทุก route · ภาพพรีวิว **1200 × 630 เป็นภาพหน้าจอผลลัพธ์จริง**
(เส้นมูลค่าพอร์ตเทียบตลาด ป้ายภาษาไทย) ไม่ใช่ภาพวาด · ข้อความทั้งสามจุดพูดเฉพาะสิ่งที่ ship แล้ว
พร้อมบรรทัดบอก**เหตุผล**ที่กองทุนไทยยังไม่เปิด (ติดสิทธิ์เข้าถึงข้อมูล ไม่ใช่ยังทำไม่ได้) ·
ระหว่างทำชนกฎเดิม **BR-DMO-06** ที่ห้ามคำว่า "กำลังพัฒนา" บนหน้าแรก จึงเปลี่ยนถ้อยคำให้ตรงกว่าเดิม
